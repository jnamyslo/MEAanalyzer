...
# Function for calculating features from files with spike detection. 3Brain
import os
import re
import h5py
import numpy as np
...
def process_file(file, well_id='Well_A1'):
    ...
    if well_id + '/SpikeTimes' in file:
        ...
        # IF TSPE SHOULD BE CALCULATED, UNCOMMENT THE FOLLOWING LINES:
            ...
            #     surrounding_window_sizes=[3, 4, 5, 6, 7, 8],  # Adjusted bin size
            ...
            # tsp_matrix is an nxn numpy array
...
def plot_feature_values_over_time(all_features_data, output_dir):
    ...
    for feature_name, time_dict in all_features_data.items():
        ...
        colors = plt.cm.Set1.colors  # Color scheme Set1
