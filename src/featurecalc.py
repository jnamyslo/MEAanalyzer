...
# Der Code erstellt anschließend Boxplots für die Features der .bxr-Dateien in den Unterordnern von Daten, sowie Rasterplots für jede Datei in den Ordnern ID2024-xx.
    ...
    for group in groups:
        ...
        for chip_dir in chip_dirs:
            ...
            for idx, bxr_file in enumerate(bxr_files, start=1):
                ...
                # Optional: Rasterplots erzeugen
                raster_plots_main(bxr_path,
                                  vector_output=False,
                                  dpi=600,
                                  output_dir=os.path.join(chip_path, 'Rasterplots'))
